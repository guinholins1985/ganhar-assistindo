...
type IconName = 'home' | 'earn' | 'add' | 'profile' | 'recommendations' | 'heart' | 'heart-filled' | 'share' | 'comment' | 'close' | 'coin' | 'gift' | 'users' | 'check-circle' | 'cog' | 'dashboard' | 'video-camera' | 'currency-dollar' | 'shield-check' | 'pencil' | 'trash' | 'eye' | 'logout' | 'moon' | 'sun' | 'menu' | 'arrow-left' | 'warning' | 'volume-up' | 'volume-off' | 'play' | 'pause' | 'rewind' | 'forward';
