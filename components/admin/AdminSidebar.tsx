...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ activeView, setActiveView, isOpen, setOpen }) => {
    return (
        <>
            ...
            <aside className={`absolute md:relative z-30 flex flex-col w-64 h-full bg-gray-800 shadow-xl transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}>
                <div className="flex items-center justify-center h-20 border-b border-gray-700">
                    <Icon name="recommendations" className="w-8 h-8 text-blue-400"/>
